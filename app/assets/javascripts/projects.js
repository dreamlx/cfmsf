...
$(document).ready(function(){
	$('.projectList').infinitescroll({
	    ...
	    nextSelector: "div.navigation a#nextPageBtn",
	    navSelector: "div.navigation",
	    contentSelector: ".projectList", // rename to pageFragment
	    extraScrollPx: 150,
	    itemSelector: ".projectList article",
	    animate: false,
	    pathParse: undefined,
	    dataType: 'html',
...
mql.addListener(function(mql) {
	...
	updateSlideBg(mql.matches);
	// console.log("655555555555555550");
});

// var mql2 = window.matchMedia("screen and (max-width:640px)");
// mql2.addListener(function(mql){
// 	console.log("6444444444444440");
// });